...
lunna = User.create!(email: "lunna@hotmail.com", password: "123456!", firstname: "Lunna", lastname: "Pomeranian", username: "Lunna's")
...
item = Item.new(name: "Sebastião Salgado", description: "Photograph" , price_per_day: "79€", category_name: "Photographs", user: lunna)
item.image.attach(io: file, filename: "nes.png", content_type: "image/png")
item.save
